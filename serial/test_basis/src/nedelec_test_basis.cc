...
//                                              Vector<double>(dim));
    ...
    for (; cell!=endc; ++cell)
    {
        ...
        {
	  /*
            std::cout << rhs_values[q_point](0) << " " << rhs_values[q_point](1) << " " << rhs_values[q_point](2) << " "
            << rhs_values[q_point](0) << " " << rhs_values[q_point](4)  << " " << rhs_values[q_point](5) << std::endl;
	    */
