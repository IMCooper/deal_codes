...
namespace Eddy_Current
{
    ...
    {
        const double constant_epsilon0 = 0.0; // electric constant (permittivity)
    ...
    void ParameterReader::declare_parameters()
    {
        ...
        prm.enter_subsection ("Material Parameters");
        {
            ...
            prm.declare_entry("background mur", "0.0",
                              Patterns::Double(0),
            ...
            prm.declare_entry("object mur", "0.0",
                              Patterns::Double(0),
...
void MaxwellProblem<dim>::setup_system ()
{
    ...
    */
    ...
    // Geometric parts, copied in from exact soln function:
